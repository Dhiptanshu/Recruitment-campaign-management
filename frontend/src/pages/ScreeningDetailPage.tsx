...
export function ScreeningDetailPage() {
  ...
  const load = () => api.getScreening(screeningId).then(setS).catch((e) => setError(e.message));
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <div className="flex items-center gap-3">
          <StatusBadge callStatus={s.call_status} recommendation={s.recommendation} />
          {s.ai_score !== null && (
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <Field label="Recommendation" value={s.recommendation?.replace("_", " ")} />
      </div>
